...
def create_object_vocab(args, image_ids, objects, aliases, vocab):
  ...
  # object_names_set1 = set(object_names)
  # instance_obj_names = ['__image__', 'man', 'shirt', 'person', 'sign',
  #                       'head', 'leg', 'hand', 'hair', 'car', 'woman',
  #                       'ear', 'eye', 'line', 'shoe', 'door',
  #                       'wheel', 'letter', 'pant', 'chair',
  #                       'handle', 'nose', 'arm', 'plate', 'stripe', 'jacket',
  #                       'hat', 'tail', 'foot', 'face', 'tile', 'number', 'short',
  #                       'spot', 'bag', 'boy', 'helmet', 'bottle', 'glass', 'tire',
  #                       'logo', 'boat', 'umbrella', 'picture', 'girl',
  #                       'button', 'mouth', 'part', 'bird', 'box', 'banana',
  #                       'cap', 'jean', 'glasses', 'bench', 'book',
  #                       'top', 'clock', 'glove', 'bowl',
  #                       'trunk', 'bus', 'neck', 'edge', 'train', 'reflection', 'horse',
  #                       'paper', 'writing', 'kite', 'flag', 'seat', 'house', 'wing',
  #                       'board', 'lamp', 'cup', 'elephant', 'coat', 'giraffe',
  #                       'sock', 'cow', 'word', 'finger', 'dog', 'wire', 'sheep',
  #                       'zebra', 'ball', 'frame', 'back', 'skateboard', 'motorcycle',
  #                       'container', 'windshield', 'cat', 'towel', 'knob', 'boot', 'bed',
  #                       'sink', 'paw', 'surfboard', 'horn', 'pizza', 'bear', 'orange',
  #                       'engine', 'photo', 'hole', 'child', 'player', 'stand', 'mirror',
  #                       'lady', 'vehicle', 'sticker', 'pot', 'apple', 'basket', 'plane',
  #                       'key', 'tie', 'animal', 'pole', 'bike', 'truck', 'sunglass', 'design']
  # stuff_obj_names = ['window','tree', 'wall', 'building', 'ground', 'sky', 'leaf', 'grass',
  #                    'cloud', 'water', 'fence', 'rock', 'road', 'sidewalk', 'snow',
  #                    'bush', 'street', 'field', 'background', 'roof', 'post', 'branch',
  #                    'dirt', 'mountain', 'hill', 'ski', 'beach', 'wood', 'stone',
  #                    'ocean', 'wave', 'ceiling', 'floor', 'light', 'shadow', 'sand', 'brick',
  #                    'flower', 'track', 'pillow', 'headlight', 'cabinet', 'railing',
  #                    'food', 'counter', 'people', 'curtain', 'shelf', 'table', 'plant',]
  # object_names = instance_obj_names + stuff_obj_names
  # object_names_set2 = set(object_names)
  # print(object_names_set1-object_names_set2)
  # print('instance_obj_names: ', len(instance_obj_names),
  #       'stuff_obj_names: ', len(stuff_obj_names))
  ...
  for split, image_ids in splits.items():
    ...
    for image_id in image_ids:
      ...
      while len(image_object_ids) < args.max_objects_per_image:
        ...
        # image_object_names.append(0)
        # image_object_boxes.append([-0.6, -0.6, 0.5, 0.5])

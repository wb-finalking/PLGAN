...
class MaskRegressNetv2(nn.Module):
    def __init__(self, obj_feat=128, mask_size=32, map_size=64):
        ...
        conv4 = list()
        conv4.append(nn.utils.spectral_norm(nn.Conv2d(256, 256, 3, 1, 1)))
        conv4.append(nn.InstanceNorm2d(256))
        conv4.append(nn.ReLU())
        conv4.append(nn.utils.spectral_norm(nn.Conv2d(256, 1, 1, 1)))
        conv4.append(nn.Sigmoid())
